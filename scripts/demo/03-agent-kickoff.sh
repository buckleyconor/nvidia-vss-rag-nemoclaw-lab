...
echo ""
echo "beat 4 (the decision): the agent files a PROPOSAL, not a work order."
echo "Open the operator dashboard at http://localhost:8091, open the incident,"
echo "and decide: Approve, Modify or Deny. The work order exists only after you"
echo "approve (operator-dashboard-spec ADR-V04); its notification appears at"
echo "http://localhost:8091/notifications. The guide rewrite for this flow is M9."
echo ""
